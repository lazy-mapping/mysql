...
String idstring=request.getParameter("id").trim(); 
		try{
			...
			ResultSet rs=sta.executeQuery("SELECT * FROM  grade WHERE id="+idstring);
			while(rs.next()){
			...
			out.print("<script type='text/javascript'>alert('查询失败!请重新输入');window.location.href='student.jsp';</script>");	
			}
%>
